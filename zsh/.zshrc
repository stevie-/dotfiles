...
# Fix for "parameter not set" errors in strict shell environments
: ${KUBE_PS1_ENABLED:=on}
...
plugins=(alias-finder autojump aws brew docker fzf gcloud git github golang helm iterm2 kubectl pip pyenv terraform urltools vscode kube-ps1)
...
alias kn='kubens'
alias kx='kubectx'
alias my_iip='curl ifconfig.co'
alias update_sntp='sudo sntp -sS time.apple.com'


# To customize prompt, run `p10k configure` or edit ~/.p10k.zsh.
[[ ! -f ~/.p10k.zsh ]] || source ~/.p10k.zsh

# Created by `pipx` on 2021-04-14 10:04:57
path+=("$HOME/.local/bin")

# git in english
[[ $HOME == "/Users/stevie" ]] && export LANG=en_US.UTF-8
